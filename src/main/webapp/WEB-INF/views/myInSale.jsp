        ...
        <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-body">
                      <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"> <a href="<c:url value='/myBooks/myInSale'/>"><i class="fa fa-book"></i> Books in sale</a> </li>
                      ...
                      <h1>My books in sale</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach items="${productInSaleList }" var="productInSale">
                                    <tr>
                                        <td># <c:out value="${productInSale.productID}"/> </td>
                                        <td><a href="#"><img src="<c:url value='/product_pic/${productInSale.picture}'/>" ></a></td>
                                        <td><c:out value="${productInSale.name}"/></td>
                                        
                                        <td>
                                        <a href="<c:url value='/detail/${productInSale.productID}'/>" class="btn btn-primary btn-sm" id = "viewsale">View</a>
                                        <a href="<c:url value='/myBooks/myInSale/delete/${productInSale.productID}'/>" class="btn btn-primary btn-sm" id ="deletesale">delete</a>
                                        </td>
                                    </tr>
                                 </c:forEach>  
