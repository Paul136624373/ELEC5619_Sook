...
<body>
    <!-- *** TOPBAR *** -->
		<c:if test="${forumModel.userName != null}">
			<div id="top">
				<div class="container">
	                ...
	                <div class="panel panel-default sidebar-menu">
	                    ...
	                    <div class="panel-body">
	                        <ul class="nav nav-pills nav-stacked category-menu">
	                            <li class="active">
	                                <a href="#">All <span class="badge pull-right"></span></a>
	                            </li>
	                            <li>
								...
								<li>
	                                <a href="<c:url value='/forum/myPost' />">My post  <span class="badge pull-right"></span></a>
	                            </li>
	                        </ul>
                ...
                <div class="col-md-9">
                    ...
                    <div class="table100 ver1 m-b-110">
							...
							<table>
								<thead>
									<tr class="row100 head">
										<th class="cell100 column1">Post title</th>
										<th class="cell100 column2">Creation time</th>
						...
						<div class="table100-body js-pscroll">
							<table>
								<tbody>
									<c:forEach begin="1" end="${fn:length(forumModel.allPosts)}" varStatus="stat">
										<tr class="row100 body">
											<td class="cell100 column1"><a href="<c:url value='/forum/viewPost/${forumModel.allPosts[fn:length(forumModel.allPosts)-stat.index].postID}' />"><c:out value="${forumModel.allPosts[fn:length(forumModel.allPosts)-stat.index].title}" /></a></td>
											<td class="cell100 column2"><c:out value="${forumModel.allPosts[fn:length(forumModel.allPosts)-stat.index].creationTime}" /></td>
											<td class="cell100 column3"><c:out value="${forumModel.allPosts[fn:length(forumModel.allPosts)-stat.index].author}" /></td>
											<td class="cell100 column4"><c:out value="${forumModel.allPosts[fn:length(forumModel.allPosts)-stat.index].type}" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
