    ...
    <div id="all">
        <div id="content">
            <div class="container">
                ...
                <div style="width:100%" class="col-md-9" id="customer-order">
                    <div class="box">
                        <h2>Order #${recordID}</h2>
                        <p id="about_order">Order #${recordID} was placed on <strong>${date}</strong>.
                           ...
                           <table class="table">
                                ...
                                <tbody>
									...
									<tr>
										<td></td>
										<td>
                                            <img src="<c:url value='/product_pic/${product.picture}' />" alt="Book Pic">
                                        </td>
                        ...
                        <div id="address_detail" class="row addresses">
                            <div class="col-md-12">
