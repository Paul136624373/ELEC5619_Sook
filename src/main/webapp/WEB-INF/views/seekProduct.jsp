...
<!-- *** TOPBAR *** -->
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li class="active">
                                    <a href="<c:url value='/viewProducts/viewAll' />">All Books <span class="badge pull-right"></span></a>
                                    <ul>
                                        <li ><a href="<c:url value='/viewProducts/Education'/>">Education</a>
                                        </li>
                                        <li ><a href="<c:url value='/viewProducts/Lifestyle'/>">LifeStyle</a>
                                        ...
                                        <li><a href="<c:url value='/viewProducts/Businesses'/>">Business & Economics</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Prices <a class="btn btn-xs btn-danger pull-right" href="<c:url value='/viewProducts/clear/price'/>"><i class="fa fa-times-circle"></i> Clear</a></h3>
                        </div>

                        <div class="panel-body">
                            <!--add name and value to get the value of checkbox-->
                            <form class="navbar-form" role="choosePrice" method="post"  action="<c:url value='/viewProducts/price'/>">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="${lowest}" name="lowest">
                                </div>
                                <div class="input-group" style="margin-top:10px">
                                    <input type="text" class="form-control" placeholder="${highest}" name="highest">
                                </div>
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Regions <a class="btn btn-xs btn-danger pull-right" href="<c:url value='/viewProducts/clear/city'/>"><i class="fa fa-times-circle"></i> Clear</a></h3>
                        </div>

                        <div class="panel-body">
                            <!--add name and value to get the value of checkbox-->
                            <form class="navbar-form" role="city" method="get" action="<c:url value='/viewProducts/city'/>">
                                <div class="input-group" >
                                        <select name="City" style="height:33px;width:145pt" class="form-control">
                                            <option value="" selected><c:out value="${city}" /></option>
                ...
                <div class="col-md-9">
                    ...
                    <div class="box info-bar">
                        <div class="row">
                            <div class="col-sm-12 col-md-4 products-showing">
                                Showing <strong><c:out value="${fn:length(seekProducts)}" /></strong> of <strong><c:out value="${allSize}" /></strong> products
                            </div>

                            <div class="col-sm-12 col-md-8  products-number-sort">
                                <div class="row">
                                    <form class="form-inline" role="sortby" method="get" action="<c:url value='/viewProducts/sort'/>">
                    ...
                    <div class="row products" id="productlist"> <!-- /.col-md-4 -->
                    
                    <c:forEach begin="1" end="${fn:length(seekProducts)}" varStatus="stat">
                        <div class="col-md-4 col-sm-6">
									<div class="product">
										<div class="flip-container">
											<div class="flipper">
												<div class="front">
													<a href="<c:url value='/detail/${seekProducts[fn:length(seekProducts)-stat.index].productID}' />">
														<img style="width: 400px; height: 300px; overflow: hidden" src="<c:url value='/product_pic/${seekProducts[fn:length(seekProducts)-stat.index].picture}' />" alt="" class="img-responsive">
													</a>
												</div>
												<div class="back">
													<a href="<c:url value='/detail/${seekProducts[fn:length(seekProducts)-stat.index].productID}' />">
										...
										<a href="<c:url value='/detail/${seekProducts[fn:length(seekProducts)-stat.index].productID}' />" class="invisible">
											<img style="width: 400px; height: 300px; overflow: hidden" src="<c:url value='/product_pic/${seekProducts[fn:length(seekProducts)-stat.index].picture}' />" alt="" class="img-responsive">
										</a>
										<div class="text">
											<h3><a href="<c:url value='/detail/${seekProducts[fn:length(seekProducts)-stat.index].productID}' />"><c:out value="${seekProducts[fn:length(seekProducts)-stat.index].name}" /></a></h3>
											<p class="price">$<c:out value="${seekProducts[fn:length(seekProducts)-stat.index].price}" /></p>
											<p class="buttons">
												<a href="<c:url value='/detail/${seekProducts[fn:length(seekProducts)-stat.index].productID}' />" class="btn btn-default">View detail</a>
												<a href="<c:url value='/viewProducts/seek/${seekProducts[fn:length(seekProducts)-stat.index].productID}'/>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</p>
										</div>
									</div>
								</div>
...
<!-- *** FOOTER *** -->
        ...
        <div id="copyright">
            <div class="container">
                ...
                <div class="col-md-6">
                    <p class="pull-right">Template by <a href=" ">Bootstrapious.com</a ></p >
                </div>
            </div>
        </div>
        <!-- *** COPYRIGHT END *** -->
