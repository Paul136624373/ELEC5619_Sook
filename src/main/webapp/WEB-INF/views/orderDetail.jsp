            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>My Orders/Order #<c:out value="${theRecord.recordID}"/></li>
                    </ul>
        ...
        <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-body">
                      <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"> <a href="<c:url value='/myOrders'/>"><i class="fa fa-list"></i> My orders</a></li>
				...
				<div class="col-md-9" id="customer-order">
                    <div class="box">
                        <h1>Order #<c:out value="${theRecord.recordID}"/></h1>

                        <p class="lead">Order #<c:out value="${theRecord.recordID}"/> was placed on <strong><c:out value="${theRecord.date}"/></strong> and is currently <strong>Being prepared</strong>.</p>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                	<c:forEach items="${productList}" var="theProduct">
                                    <tr>
                                        <td>
                                            <a href="#">
                                                <img src="<c:url value='/product_pic/${theProduct.picture}'/>" alt="book in order">
                                            </a>
                                        </td>
                                        <td><a href="detail.html"><c:out value="${theProduct.name}"/></a>
                                        </td>
                                        <td># <c:out value="${theProduct.productID}"/></td>
                                        <td>1</td>
                                        <td>$ <c:out value="${theProduct.price}"/></td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th>$ <c:out value="${theRecord.totalPrice}"/></th>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <div class="row addresses">
                            ...
                            <div class="col-md-12">
                                ...
                                <p> <c:out value="${theBuyer.name}"/>
                                    <br><c:out value="${theBuyer.address}"/>
                                    <br><c:out value="${theBuyer.suburb}"/>
                                    <br><c:out value="${theBuyer.city}"/> NSW <c:out value="${theBuyer.postcode}"/>
                                    <br>Australia</p>
                            </div>
                        </div>
