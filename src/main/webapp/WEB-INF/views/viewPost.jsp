...
<head>
	...
	<script>
		...
		function validReply() {
    		...
    		{
    			alert("The content of reply cannot be empty.");
    			return false;
    		}
	    	else
	    	{
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><c:out value="${thePost.title}" /></li>
                    </ul>

                    <div class="container-fluid" style="border:1px solid #DCDBDB; padding-bottom:20px; margin-bottom:10px; background-color:#FFF; border-radius:5px 5px;">
						<div class="row-fluid">
							<div class="col-md-12">
								<h3 class="text-center">
									<c:out value="${thePost.title}" />
								</h3>
								<h5 class="text-center" style="padding-bottom:5px;">
									Author: <c:out value="${thePost.author}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time of creation: <c:out value="${thePost.creationTime}" />
								</h5>
								<div class="row-fluid">
									<div class="col-md-12">
										<div style="padding-left:5px;padding-right:5px;border:1px solid #DCDBDB;width:100%; min-height:200px; border-radius:5px 5px; overflow-y:auto; font-size:20px;margin-bottom:10px">
											<c:out value="${thePost.content}" />
										</div>
										<c:if test='${thePost.imgPath != ""}'>
											<img alt="IMG" src="<c:url value='/post_img/${thePost.imgPath}' />" class="img-polaroid" style="height:200px; margin-top:10px; margin-bottom:10px;"/>
										</c:if>
									</div>
								</div>
								<div class="row-fluid">
									<div class="col-md-12">
										<table class="table" style="border:1px solid #DCDBDB; margin-bottom:20px; background-color:#FFF; margin-top:10px">
											<thead>
												<tr>
													<th class="info">
														Replies:
								...
								<c:if test="${userName != null}">
									<div class="row-fluid">
										<div class="col-md-12">
											<form action="createComment" method="post" onsubmit="return validReply()">
												<div style="padding-top: 20px">
													<input value="${thePost.postID}" type="text" id="postID" name="postID" style="display: none;">
												</div>
												<table class="table" style="border:1px solid #DCDBDB; margin-bottom:20px; background-color:#FFF">
													<thead>
														<tr>
															<th class="info">
																Create a new reply:
													...
													<tbody>
														<tr>
															<td>
																<textarea id="replyContent" name="replyContent" placeholder="Enter the content here..."></textarea>
															</td>
														</tr>
														<tr>
															<td>
																<button class="btn btn-info" type="button" style="float:left; width:150px" onclick="clearComment()">Clear</button>
																<input type="submit" value="Submit"  class="btn btn-success" style="float:right; width:150px">
															</td>
														</tr>
													</tbody>
												</table>
