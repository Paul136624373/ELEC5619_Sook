...
<!-- *** TOPBAR *** -->
 ...
 _________________________________________________________ -->
                   <div class="panel panel-default sidebar-menu">
                    ...
                    <div clas = "col-sm-9" align="center">
                    <div class="container">
                    <div class="row" align="center">
                    <div class="col-sm-3">
                    <img style="vertical-align:middle" src="<c:url value='/product_pic/${oneProduct.picture}'/>" width="250" height="300px">
                    <br>
                    <br>
                    </div>
                    <div class="col-sm-5" align="left"><a> <h2><c:out value="${oneProduct.name}"/></h2></a>
                    			<h3><label>Price: $ <c:out value="${oneProduct.price}"/></label></h3>
                    			
                    			<h4><label>Category: <c:out value="${oneProduct.category}"/></label></h4>
                    			<h4><label> Location: <c:out value="${oneProduct.location}"/></label></h4>
                    			<h4><label>Means of transaction: <c:out value="${oneProduct.mean}"/></label></h4>
                    			  <a href="<c:url value='/viewProducts/view/${oneProduct.productID}'/>" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">Add to cart</span></a>
                    </div>
                    <div class="col-sm-7" align="left"><div class="box"><h3>Description:</h3><p><c:out value="${oneProduct.description}"/></p></div>
                    	</div>
                    </div>
