	                ...
	                <div class="panel panel-default sidebar-menu">
	                    ...
	                    <div class="panel-body">
	                        <ul class="nav nav-pills nav-stacked category-menu">
	                            ...
	                            <li class="active">
	                                <a href="#">Seek to purchase  <span class="badge pull-right"></span></a>
	                            </li>
	                            <li>
                ...
                <div class="col-md-9">
                    ...
                    <div class="table100 ver1 m-b-110">
						...
						<div class="table100-body js-pscroll">
							<table>
								<tbody>
									<c:forEach begin="1" end="${fn:length(seekBookPosts)}" varStatus="stat">
										<tr class="row100 body">
											<td class="cell100 column1"><a href="<c:url value='/forum/viewPost/${seekBookPosts[fn:length(seekBookPosts)-stat.index].postID}' />"><c:out value="${seekBookPosts[fn:length(seekBookPosts)-stat.index].title}" /></a></td>
											<td class="cell100 column2"><c:out value="${seekBookPosts[fn:length(seekBookPosts)-stat.index].creationTime}" /></td>
											<td class="cell100 column3"><c:out value="${seekBookPosts[fn:length(seekBookPosts)-stat.index].author}" /></td>
											<td class="cell100 column4"><c:out value="${seekBookPosts[fn:length(seekBookPosts)-stat.index].type}" /></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
