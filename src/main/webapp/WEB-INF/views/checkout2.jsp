                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="box shipping-method">
                                            <h4>Face to face transaction</h4>
                                            <p>You can choose to pick up the book in person with the seller.</p>
                                            <p>Please consult with the seller in private.</p>
                                            <div class="box-footer text-center">
                                                <input type="radio" name="delivery" value="face" checked>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="box shipping-method">
                                            ...
                                            <p>Free shipping for orders over $200 via Australia post. </p>
											<p>Otherwise we offer flat rate shipping of $10.</p>
                                            <div class="box-footer text-center">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box shipping-method">
                                            ...
                                            <p>Free for orders over $300 </p>
											<p>We offer flat rate $15 via Australia Post for orders under $300.</p>
                                            <div class="box-footer text-center">
