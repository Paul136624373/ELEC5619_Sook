                    ...
                    <div class="table100 ver1 m-b-110">
							...
							<table>
								<thead>
									<tr class="row100 head">
										<th class="cell100 column1">Edit the post</th>
									</tr>
								</thead>
							</table>
						</div>
						...
						<form action="editPost" method="post" enctype="multipart/form-data">
									...
									<tbody>
										<tr class="row100 body">
											...
											<td class="cell100" width="45%">
												<span>
													<input type="text" name="title" placeholder="Type the title here..." value="${thePost.title}"/>	
												</span>
											</td>
											<td class="cell100" width="10%"><font size="4" face="Verdana"><b>Category:</b></font></td>
											<td class="cell100" width="40%">
												<div class="button custom-select">
													<c:if test='${thePost.type == "Seek"}'>
														<select name="type">
							...
							<div style="padding-left: 20px; padding-right: 20px">
								<textarea name="content" id="styled" placeholder="Enter the content here..."> ${thePost.content}</textarea>
							</div>
										...
										<tr class="row100 body">
											<td class="cell100" style="padding-left: 30px">
												...
												<c:if test='${thePost.imgPath != ""}'>
													<img id="imgArea" style="height:200px; cursor:pointer;" onclick="tempClick()" src="<c:url value='/post_img/${thePost.imgPath}' />"></img>
													<div style="padding-top: 20px">
														<input name="oldPath" id="oldPath" type="text" value="${thePost.imgPath}" style="display: none;">
													</div>
												</c:if>
							...
							<div style="padding-top: 20px">
								<input type="text" id="postID" name="postID" style="display: none;" value="${thePost.postID}"/>
							</div>
							
							<div style="padding-top: 20px">
								<input type="text" id="author" name="author" style="display: none;" value="${thePost.author}"/>
							</div>
							
							<div style="padding-top: 20px">
								<input type="text" id="creationTime" name="creationTime" style="display: none;" value="${thePost.creationTime}"/>
							</div>
									...
									<tbody>
										<tr>
											<td width="50%" style="padding-left: 20px">
												<a href="<c:url value='/forum/myPost'/>" class="btn btn-primary navbar-btn" style="float:left"><font size="3">
							                        <span class="hidden-sm">Cancel</span></font>
							                    </a>
											</td>
											<td width="50%" style="padding-right: 20px">
												<input type="submit" value="Save Post" class="btn btn-primary navbar-btn" style="float:right">
											</td>
										</tr>
									</tbody>
								</table>
