...
<head>
    ...
    function validPassword(){
    	var oldpw = ${theUser.password};
    	var inputOld = document.getElementById("password_old").value;
    	var inputNew1 = document.getElementById("password_1").value;
    	var inputNew2 = document.getElementById("password_2").value;
    	if(oldpw != inputOld){
    		alert("The old password is wrong.");
			return false;
    	}
    	if(inputNew1!=inputNew2){
    		alert("The two new passwords are not same.");
			return false;
        ...
        <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-body">
                      <ul class="nav nav-pills nav-stacked">
                        <li class="active"> <a href="<c:url value='/myInfo'/>"><i class="fa fa-user"></i> My Information</a> </li>
                        <li> <a href="<c:url value='/myOrders'/>"><i class="fa fa-list"></i> My orders</a></li>
                        <li> <a href="<c:url value='/myBooks/mySold'/>"><i class="fa fa-book"></i> My sold books</a> </li>
               ...
               <div class="col-md-9">
                    <div class="box"><h2>Hello! <c:out value="${theUser.email}"></c:out></h2>
                    <p class="lead">Change your personal details or your password here.</p>
                        <p class="text-muted">* field is compulsory.</p>

                        <h3>Change password</h3>

                        <form  action="<c:url value='/myInfo/password/${theUser.userID}'/>" method="post" onsubmit="return validPassword()">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password_1" name="new_pw">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                        ...
                        <form action="<c:url value='/myInfo/edit/${theUser.userID}'/>" method="post" onsubmit="return validNameInput()">
                                                 <div class="content">
	                                ...
	                                <div class="row">
	                                    ...
	                                    <div class="col-sm-6">
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" class="form-control" id="address" name="address" value="${theUser.address}">
	                                        </div>
	                                    </div>
	                                </div>
	                                <!-- /.row -->
	                                ...
	                                <div class="row">
	                                    ...
	                                    <div class="col-sm-6">
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" class="form-control" id="suburb" name="suburb" value="${theUser.suburb}">
	                                        </div>
	                                    </div>
	                               </div>
	                                <!-- /.row -->
	                                ...
	                                <div class="row">
	                                    <div class="col-sm-6">
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" class="form-control" id="postcode" name="postcode" value="${theUser.postcode}">
	                                        </div>
	                                    </div>
	                                    <div class="col-sm-6">
	                                        <div class="form-group">
	                                            <label for="telephone">Telephone</label>
	                                            <input type="text" class="form-control" id="telephone"  name="telephone" value="${theUser.telephone}">
	                                        </div>
	                                    </div>
	                                ...
	                                <div class="row" style="display: none;"> <!-- style="display: none;" -->
	                                    <div class="col-sm-6 col-sm-3">
	                                        <div class="form-group">
	                                            <input type="text" id="userID" name="userID" value="${theUser.userID}">
	                                        </div>
	                                    </div>
	                                    <div class="col-sm-6 col-sm-3">
	                                        <div class="form-group">
	                                            <input type="text" id="email"  name="email" value="${theUser.email}">
	                                        </div>
	                                    </div>
	                                    <div class="col-sm-6 col-sm-3">
	                                        <div class="form-group">
	                                            <input type="text" id="password" name="password" value="${theUser.password}">
	                                        </div>
	                                    </div>
	                                    <div class="col-sm-6 col-sm-3">
	                                        <div class="form-group">
	                                            <input type="text" id="state"  name="state" value="NSW">
	                                        </div>
	                                    </div>
