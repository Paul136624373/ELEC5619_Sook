        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12" id="checkout">
                    <div class="box">
                        <form method="post" action="checkout1" onsubmit="return validInfo()">
                            <h1>Checkout</h1>
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <c:if test='${Buyer.city == null || Buyer.city == ""}'>
                                            ...
                                            <c:if test='${Buyer.city == "Newcastle"}'>
	                                            <select class="form-control" id="city" name="city">
	                                            	<option value="">-- City --</option>
	                                            	<option value="Sydney">Sydney</option>
	                                            	<option value="Albury">Albury</option>
                                            ...
                                            <c:if test='${Buyer.city == "Wollongong"}'>
	                                            <select class="form-control" id="city" name="city">
	                                            	<option value="">-- City --</option>
	                                            	<option value="Sydney" >Sydney</option>
	                                            	<option value="Albury">Albury</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="suburb" name="suburb" value="${Buyer.suburb}">
                                        </div>
                                    </div>
                               </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="postcode" name="postcode" value="${Buyer.postcode}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="telephone">Telephone</label>
                                            <input type="text" class="form-control" id="telephone"  name="telephone" value="${Buyer.telephone}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="display: none;"> 
                                    <div class="col-sm-6 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="userID" name="userID" value="${Buyer.userID}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="email"  name="email" value="${Buyer.email}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-sm-3">
                                        <div class="form-group">
                                            <input type="text" id="password" name="password" value="${Buyer.password}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-sm-3">
                                        <div class="form-group">
