		...
		<div id="content">
           <div class="container">
               ...
               <div class="col-md-12" id="basket">
                   <div class="box">
					<h1>Shopping cart</h1>
					<p class="text-muted">You currently have <c:out value="${cartModel.number}"/> item(s) in your cart.</p>
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
                                  	<c:forEach items="${cartModel.shoppingCart}" var="shoppingcart">
                                  	<tr>
									<td>
									<c:if test="${shoppingcart.choose == true}">
										<input name="buy" checked type="checkbox" value="" onClick="location='<c:url value="/shoppingCart/selectCart/${shoppingcart.productID}" />'" >
									</c:if>
									<c:if test="${shoppingcart.choose == false}">
										<input name="buy" type="checkbox" value="" onClick="location='<c:url value="/shoppingCart/selectCart/${shoppingcart.productID}" />'" >
									</c:if>
									</td>
                                       <td>
                                       ...
                                       <td>
                                       	<a href="<c:url value='/detail/${shoppingcart.productID}' />" ><c:out value="${shoppingcart.productName}"/></a>
                                       </td>
                                       <td>1</td>
                                       <td>$<c:out value="${shoppingcart.productPrice}"/></td>
                                       <td>
                                       	<a href="<c:url value='/shoppingCart/deleteCart/${shoppingcart.productID}' />" ><i class="fa fa-trash-o"></i></a>
                                       </td>
                                   </tr>
								</c:forEach>
							</tbody>
							<tfoot>
								<tr>
									...
									<th colspan="2">$<c:out value="${cartModel.total}"/></th>
								</tr>
							</tfoot>
						</table>
					</div>
					<!-- /.table-responsive -->
                       <div class="box-footer">
                           <div class="pull-left">
                               <a href="<c:url value='/viewProducts' />" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                           </div>
                           <div class="pull-right">                         
                               <button type="submit" class="btn btn-primary" onClick="location='<c:url value="/shoppingCart/checkout1" />'">Proceed to checkout <i class="fa fa-chevron-right"></i>
                               </button>
                           </div>
                       </div>
                   </div>
