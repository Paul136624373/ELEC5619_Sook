        ...
        <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-body">
                      <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"> <a href="<c:url value='/userOrders'/>"><i class="fa fa-list"></i> My orders</a></li>
				...
				<div class="col-md-9" id="userOrders">
                    <div class="box">
                        <h1>My orders</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <c:forEach items="${allRecord}" var="allRecord" >
                                    <tr>
                                        <th># <c:out value="${allRecord.recordID}"></c:out></th>
                                        <td><c:out value="${allRecord.date}"></c:out></td>
                                        <td>$ <c:out value="${allRecord.totalPrice}"></c:out></td>
                                        
                                        <td><a href="<c:url value='/myOrders/orderDetail/${allRecord.recordID}'/>" class="btn btn-primary btn-sm" >View</a>
                                        </td>
                                    </tr>
                                    </c:forEach>
